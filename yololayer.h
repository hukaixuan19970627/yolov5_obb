...
namespace Yolo
{
	...
	static constexpr int CLASS_NUM = 55+180;//类别是你的检测类别+180个角度类别
    static constexpr int INPUT_H = 800;  // yolov5's input height and width must be divisible by 32.
    static constexpr int INPUT_W = 800;

...
The results on **DOTA_subsize1024_gap200_rate1.0** test-dev set are shown in the table below. (**password: yolo**)
 ...
 |yolov5s [[baidu](https://pan.baidu.com/s/1QWeZW7hW_oUh7D_0WokINQ)]        |1024  | ×     |**76.79**   |-      |-      |-      |**15.6**  | -     |**7.54**     |**17.5**    
 |yolov5n [[baidu](https://pan.baidu.com/s/1QWeZW7hW_oUh7D_0WokINQ)]        |1024  | ×     |**73.26**   |-      |-      |-      |**15.2**  | -     |**2.02**     |**5.0**
